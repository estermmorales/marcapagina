        ...
        <div class="relative p-4  max-w-2xl max-h-md md:max-h-screen">
            ...
            <div class="relative bg-white rounded-sm shadow">
                ...
                <form action="<?= base_url('/delete'); ?>" method="post" class="p-4 md:p-5" id="confirm-form">
                    ...
                    <button type="button" class="inline-flex items-center px-5 py-2.5 text-center mt-3 bg-gray-50 hover:bg-gray-100 text-gray-800 text-sm font-medium rounded border close-modal" data-modal-toggle="confirm-modal">
