        ...
        <div class="relative p-4 w-full max-w-2xl max-h-md md:max-h-screen">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-center justify-between p-3 border-b rounded-t ">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-600 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center close-modal" data-modal-toggle="edit-modal">
